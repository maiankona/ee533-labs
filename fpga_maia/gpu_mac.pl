...
my @program = (
    ...
    0x65000300,  # [2]  MOVI r8, #0xC0
    0x65200000,  # [3]  MOVI r9, #0	 (accumulator)
    0x00000000,  # [4]  NOP
    0x48460000,  # [5]  LDR  r2, [r6]
    0x00000000,  # [6]  NOP
    0x00000000,  # [7]  NOP
    0x00000000,  # [8]  NOP
    0x48850000,  # [9]  LDR  r4, [r5]
    0x00000000,  # [10] NOP
    0x00000000,  # [11] NOP
    0x00000000,  # [12] NOP
    0x25222000,  # [13] VMAC r9, r2, r4
    0x00000000,  # [14] NOP
	0x00000000,  # [15] NOP
    0x00000000,  # [16] NOP
    0x00000000,  # [17] NOP
...
sleep(1);
regwrite($IDS_DMEM_IN_LO, 0x40804080);
sleep(1);
regwrite($IDS_DMEM_IN_HI, 0x40804080);
sleep(1);
...
sleep(1);
regwrite($IDS_DMEM_IN_LO, 0xc040c040);
sleep(1);
regwrite($IDS_DMEM_IN_HI, 0xc040c040);
sleep(1);
regwrite($IDS_INPUT_TYPE, $DMEM_WE);
sleep(1);
regwrite($IDS_INPUT_TYPE, 0x00);
...
my $expected_lo = 0xc140c140;
my $expected_hi = 0xc140c140;
