...
`define IDS_INPUT_TYPE         4'h0
`define IDS_ADDRESS            4'h1
`define IDS_IMEM               4'h2
`define IDS_DMEM               4'h3
`define IDS_DMEM_OUT           4'h4
`define IDS_ALU_OUT_CHECK      4'h5
`define IDS_CPU_EXTRACT_CHECK  4'h6
`define IDS_PACKET_CHECK_HIGH  4'h7
`define IDS_PACKET_CHECK_MID   4'h8
`define IDS_PACKET_CHECK_LOW   4'h9
