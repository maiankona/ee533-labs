...
def DEVICE_PROJ_DIR ():
    return "lab8_CPU32_FIFO"

def DEVICE_PROJ_NAME ():
    return "IDS"

def DEVICE_PROJ_DESC ():
    return "pipe and fifo"
...
def IDS_DMEM_OUT_REG ():          
    return 0x2000210

def IDS_ALU_OUT_CHECK_REG ():     
    return 0x2000214

def IDS_CPU_EXTRACT_CHECK_REG (): 
    return 0x2000218

def IDS_PACKET_CHECK_HIGH_REG (): 
    return 0x200021c

def IDS_PACKET_CHECK_MID_REG ():  
    return 0x2000220

def IDS_PACKET_CHECK_LOW_REG ():  
    return 0x2000224
...
__main__.nf_regmap.update({
    ...
    0x2000200 : "IDS_INPUT_TYPE_REG",
    0x2000204 : "IDS_ADDRESS_REG",
    0x2000208 : "IDS_IMEM_REG",
    0x200020c : "IDS_DMEM_REG",
    0x2000210 : "IDS_DMEM_OUT_REG",
    0x2000214 : "IDS_ALU_OUT_CHECK_REG",
    0x2000218 : "IDS_CPU_EXTRACT_CHECK_REG",
    0x200021c : "IDS_PACKET_CHECK_HIGH_REG",
    0x2000220 : "IDS_PACKET_CHECK_MID_REG",
    0x2000224 : "IDS_PACKET_CHECK_LOW_REG",
