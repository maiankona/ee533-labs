...
#
# Project: IDS (lab6_debug_integrateNetwork)
# Description: pipe
#
#############################################################

package reg_defines_lab6_debug_integrateNetwork;
...
sub DEVICE_PROJ_DIR ()  { "lab6_debug_integrateNetwork"; }
sub DEVICE_PROJ_NAME () { "IDS"; }
sub DEVICE_PROJ_DESC () { "pipe"; }
...
# File: projects/lab6_debug_integrateNetwork/include/ids.xml
sub IDS_PATTERN_HIGH_REG ()    { 0x2000200;}
sub IDS_PATTERN_LOW_REG ()     { 0x2000204;}
sub IDS_IDS_CMD_REG ()         { 0x2000208;}
sub IDS_INPUT_TYPE_REG ()      { 0x200020c;}
sub IDS_ADDRESS_REG ()         { 0x2000210;}
sub IDS_IMEM_REG ()            { 0x2000214;}
sub IDS_DMEM_REG ()            { 0x2000218;}
sub IDS_MATCHES_REG ()         { 0x200021c;}
sub IDS_DMEM_OUT_REG ()        { 0x2000220;}
sub IDS_ALU_INTERCEPT_REG ()   { 0x2000224;}
