...
#
# Project: IDS (lab8_CPU32_FIFO)
# Description: pipe and fifo
#
#############################################################

package reg_defines_lab8_CPU32_FIFO;
...
@EXPORT = qw(
                ...
                IDS_DMEM_REG
                IDS_DMEM_OUT_REG
                IDS_ALU_OUT_CHECK_REG
                IDS_CPU_EXTRACT_CHECK_REG
                IDS_PACKET_CHECK_HIGH_REG
                IDS_PACKET_CHECK_MID_REG
                IDS_PACKET_CHECK_LOW_REG
                OQ_QUEUE_0_CTRL_REG
...
sub DEVICE_PROJ_DIR ()  { "lab8_CPU32_FIFO"; }
sub DEVICE_PROJ_NAME () { "IDS"; }
sub DEVICE_PROJ_DESC () { "pipe and fifo"; }
...
# File: projects/lab8_CPU32_FIFO/include/ids.xml
sub IDS_INPUT_TYPE_REG ()          { 0x2000200;}
sub IDS_ADDRESS_REG ()             { 0x2000204;}
sub IDS_IMEM_REG ()                { 0x2000208;}
sub IDS_DMEM_REG ()                { 0x200020c;}
sub IDS_DMEM_OUT_REG ()            { 0x2000210;}
sub IDS_ALU_OUT_CHECK_REG ()       { 0x2000214;}
sub IDS_CPU_EXTRACT_CHECK_REG ()   { 0x2000218;}
sub IDS_PACKET_CHECK_HIGH_REG ()   { 0x200021c;}
sub IDS_PACKET_CHECK_MID_REG ()    { 0x2000220;}
sub IDS_PACKET_CHECK_LOW_REG ()    { 0x2000224;}
