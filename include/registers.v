...
//
// Module: registers.v
// Project: IDS (WS_slidingLSH_alignmentAccelerator)
...
`define DEVICE_PROJ_DIR    "WS_slidingLSH_alignmentAccelerator"
`define DEVICE_PROJ_NAME   "IDS"
`define DEVICE_PROJ_DESC   "pipe and fifo"
...
`define IDS_BLOCK_ADDR_WIDTH            18
`define IDS_REG_ADDR_WIDTH              5
...
`define IDS_BLOCK_ADDR            18'h00004
...
// File: projects/WS_slidingLSH_alignmentAccelerator/include/ids.xml
`define IDS_INPUT_TYPE          5'h0
`define IDS_ADDRESS             5'h1
`define IDS_IMEM                5'h2
`define IDS_DMEM                5'h3
`define IDS_DMEM_OUT            5'h4
`define IDS_GPU_UPPER           5'h5
`define IDS_GPU_LOWER           5'h6
`define IDS_RESULT_CHECK_UPPER  5'h7
`define IDS_RESULT_CHECK_LOWER  5'h8
`define IDS_CPU_STORE           5'h9
`define IDS_CPU_PC_THREAD0      5'ha
`define IDS_CPU_REQUEST         5'hb
`define IDS_ALU_ZERO            5'hc
`define IDS_PACKET_CHECK_UPPER  5'hd
`define IDS_PACKET_CHECK_MID    5'he
`define IDS_PACKET_CHECK_LOWER  5'hf
`define IDS_PACKET_OUT_UPPER    5'h10
`define IDS_PACKET_OUT_MID      5'h11
`define IDS_PACKET_OUT_LOWER    5'h12
