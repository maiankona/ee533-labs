...
module pipeline_pseudoARM(
    ...
    // --- MEM stage outputs for gpu_control_interface_2 ---
    // cpu_mem_addr: lower 8 bits of ALU result (store address)
    // cpu_mem_data: store data zero-extended to 64 bits
    // cpu_mem_we:   store is in MEM stage
    ...
    wire [40:0] me_wb_d = {
        ...
        ex_me_q[4:1],   // [5:2] rd  -- corrected slice
        ex_me_q[0]      // [1] wrege
    };
