...
localparam [15:0] F05P0  = 16'h3F00;
localparam [15:0] F05N0  = 16'hBF00;
...
initial begin
    ...
    wait_done;
    check_result("VSUB 1-0.5     ", {4{F05P0}});

    // VSUB: 0.5 - 1.0 = -0.5
    issue_cmd(6'h07, {4{F0P5}}, {4{F1P0}}, 64'h0);
    wait_done;
    check_result("VSUB 0.5-1     ", {4{F05N0}});

    // VSUB: 1.0 - 1.0 = 0.0
    issue_cmd(6'h07, {4{F1P0}}, {4{F1P0}}, 64'h0);
    wait_done;
    check_result("VSUB 1-1       ", 64'h0);

    // VMUL: 2.0 * 2.0 = 4.0
    issue_cmd(6'h08, {4{F2P0}}, {4{F2P0}}, 64'h0);
    wait_done;
    check_result("VMUL 2*2       ", {4{16'h4080}});

    // VMAC: 1.0 * 2.0 + 1.0 = 3.0
    issue_cmd(6'h09, {4{F1P0}}, {4{F2P0}}, {4{F1P0}});
    wait_done;
    check_result("VMAC 1*2+1     ", {4{16'h4040}});

    // VRELU: ReLU of negative input => 0
