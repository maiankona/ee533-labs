...
module pipeline_pseudoARM(
    ...
    wire [25:0] id_ex_d = { //was [108:0]
        id_curr_thread, // [25:24]   // [108:107] 2 bits
        id_alu_ctrl,    // [23:20]   // [106:103] 4 bits
        //id_r1data,         // [102:71]  32 bits (Base Addr)
        //id_alu_b,      // [70:39]   32 bits (Pre-muxed Offset)
        //id_r2data,         // [38:7]    32 bits (RAW DATA FOR STORE)
        id_immediate, //NEW SUPPORT [19:8]
        id_alu_src, //SAME HERE [7]
    ...
    // BRANCH SNIPPET
	 ...
	 wire [72:0] ex_me_d = {
        ...
        //ex_r2data,   // [38:7]  Store Data
        id_r2data,       // [38:7]  Store Data, but BRAM styled (skip a stage)
        ex_wmem_en,      // [6]     
        ex_mem_to_reg,   // [5]     
        ex_waddr,    // [4:1]   
        ex_wrege       // [0]
	...
	wire [40:0] me_wb_d = {
        ...
        me_alu_res,     // [37:6], alu_out
        ex_me_q[5],  // [5], mem_to_reg
        ex_me_q[4:1],   // [4:1], rd
        ex_me_q[0]      // [0], wrege
    };
    ...
    // WB STAGE
    assign wb_wdata = wb_mem_to_reg ? dmem_raw_output : me_wb_q[37:6]; //ARM supported mux, so to speak
    assign wb_waddr = me_wb_q[4:1]; //rd
    assign wb_wena  = me_wb_q[0]; //write reg enable for is_dp
