...
module pipeline_backup(
    ...
    // Match old working path: always forward fetched instruction into IF/ID.
    // GPU_START only repositions PC; it should not NOP-inject during normal flow.
    wire [31:0] if_id_din = instruction;
    ...
    assign pipeline_done = (instr_count >= bram_length_r) && !fetch_active
                           && (fetch_drain_ctr == 6'd0);
