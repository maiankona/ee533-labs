...
module pipeline_backup(
    ...
    // WB1/WB2 Bridge
    //
    // By now dmem_raw_output has settled (BRAM registered output
    // is valid one cycle after address). Select it for LD,
    // otherwise use ALU/tensor result carried through WB1.
    //
    //   wb2_result  64
    //   wreg         5
    //   wreg_en      1
