...
module gpu_fifo_integration_tb;
    ...
    initial begin
        ...
        // r2 @ 0x70: 4.0 in each BF16 lane
        write_dmem64(8'h70, 32'h40804080, 32'h40804080);
        // r4 @ 0x74: -3.0 in each lane
        write_dmem64(8'h74, 32'hC040C040, 32'hC040C040);

        write_imem(9'h000, 32'h64c001c0); // MOVI r6,  #0x70
        write_imem(9'h001, 32'h64a001d0); // MOVI r5,  #0x74
        write_imem(9'h002, 32'h65000300); // MOVI r8,  #0xC0   // STR dest (not r4 — VMAC needs r4)
        write_imem(9'h003, 32'h65200000); // MOVI r9,  #0     // acc = 0
        write_imem(9'h004, 32'h00000000); // NOP
        write_imem(9'h005, 32'h48460000); // LDR  r2, [r6]
        write_imem(9'h006, 32'h00000000); // NOP
        write_imem(9'h007, 32'h00000000); // NOP
        write_imem(9'h008, 32'h00000000); // NOP
        write_imem(9'h009, 32'h48850000); // LDR  r4, [r5]
        write_imem(9'h00a, 32'h00000000); // NOP
        write_imem(9'h00b, 32'h00000000); // NOP
        write_imem(9'h00c, 32'h00000000); // NOP
        write_imem(9'h00d, 32'h25222000); // VMAC r9, r2, r4
        write_imem(9'h00e, 32'h00000000); // NOP
        write_imem(9'h00f, 32'h00000000); // NOP
        write_imem(9'h010, 32'h00000000); // NOP
        write_imem(9'h011, 32'h00000000); // NOP
        write_imem(9'h012, 32'h00000000); // NOP
        write_imem(9'h013, 32'h4d280000); // STR  r9, [r8]
        write_imem(9'h014, 32'h2c000000); // HALT
        ...
        read_req_dmem  = 1'b0;
        #1;
        $display("  Result [0xC0] = 0x%016h (expect 0xc140c140c140c140)", data_out_dmem);
